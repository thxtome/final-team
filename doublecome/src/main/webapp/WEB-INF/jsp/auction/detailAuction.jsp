                ...
                <div id="slide">
                    <div class="swiper-container gallery-top">
                        ...
                        <div class="swiper-button-next swiper-button-white"
                            style="position: absolute; color: black; right: -51px;">
                        </div>
                        <div class="swiper-button-prev swiper-button-white"
                            style="position: absolute; color: black; left: -51px;">
                        </div>
                                                            ...
                                                            <div class="middle">
                                                                <div class="inner">
                                                                    <div class="counter-class"
                                                                        ...
                                                                        <div class="timer-font"><span
                                                                                class="counter-days"></span> 일</div>
                                                                        <div class="timer-font"><span
                                                                                class="counter-hours"></span> 시간</div>
                                                                        <div class="timer-font"><span
                                                                                class="counter-minutes"></span> 분</div>
                                                                        <div class="timer-font"><span
                                                                                class="counter-seconds"></span> 초</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                ...
                                <li class="ProductInformation__item js-stickyNavigation-start">
                                    ...
                                    <div class="Price Price--current">
                                        ...
                                        <div class="Price__buttonArea">
                                            <a href="#" class="Button Button--bid js-modal-show rapidnofollow"
                                                rel="nofollow" data-modal-name="error" data-ylk="rsec:bds;pos:1"
                                                data-rapid_p="7">입 찰 하 기</a>
                                        </div>
                                    </div>
                                    <div class="Price Price--buynow">
                                        ...
                                        <dd class="Price__buttonArea">
                                            ...
                                            <a href="#" class="Button Button--buynow js-modal-show rapidnofollow"
                                                rel="nofollow" data-modal-name="error" data-ylk="rsec:byitnw;pos:1"
                                                data-rapid_p="9">즉시 구매하기</a>
            ...
            <div id="bottom">
                <div calss="in_bottom">
                    <ul class="nav nav-justified">
                        <li class="nav-item nav1 movenav"><a href="#auction_contets" class="nav-link js-scroll-trigger">상품 정보</a></li>
                        <li class="nav-item nav2"><a href="#inquiry" class="nav-link js-scroll-trigger">상품 문의</a></li>
                        <li class="nav-item nav3"><a href="#seller_review" class="nav-link js-scroll-trigger">판매자 후기</a></li>
                    </ul>



                    <section id="auction_contets">
                        <div id="tab-1">
                            ...
                            <div id="inquiry_insert">
                                ...
                                <div class="inquiry_submit pdct_inquiry">
                                    ...
                                    <form id="productInquiry">
                                        <textarea class="form-control" id="inquiry-contents" placeholder="로그인 후 작성하실 수 있습니다"></textarea>
                                    </form>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-11 pdct_inquiry_item">
                                                <p class="inquiry_name col-xs-11">
                                                    <strong>나승민아님</strong>
                                                    <span class="inquiry_minute">2019-11-11</span>
                                                </p>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-xs-11 pdct_inquiry_item">
                                                            ...
                                                            <div class="clearfix"></div>
                                                        <p>은율 마유 폼클렌징, 150g, 3개 상품은 한 개의 제품 박스에 한 개씩 포장되어있는 점 참고하여 이용 부탁드립니다.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <section id="seller_review">
                        ...
                        <div class="panel-group" id="accordion1">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion1" href="#collapseOne" class="row"> 								
                                                <div class="col-xs-3 scorearea text-center">
                                                    <p class="score">8<span> 점</span></p>
                                                </div>
                                                <div clas="col-xs-8 text-center">
                                                    <p>							
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion1" href="#collapseTwo" class="row"> 								
                                                <div class="col-xs-3 scorearea text-center">
                                                    <p class="score">8<span> 점</span></p>
                                                </div>
                                                <div clas="col-xs-8 text-center">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion1" href="#collapseThree" class="row"> 								
                                                <div class="col-xs-3 scorearea text-center">
                                                    <p class="score">8<span> 점</span></p>
                                                </div>
                                                <div clas="col-xs-8 text-center">
