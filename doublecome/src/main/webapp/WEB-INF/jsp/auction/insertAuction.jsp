...
<body>
	...
	<div id="wrapper">
		<div class="contents">
			<form id="insertForm" method="post" enctype="multipart/form-data" action="<c:url value="/file/upload.do" />">
				<div class="formbox">
					<dl class="row">
						...
						<dd class="col-xs-9 line_height_clean">
							<dl class="row">
								<dd class="col-xs-4 line_clean">
									<p class="won">원</p>
									<input type="text" class="start inputwon" />
								</dd>
								<dt class="col-xs-2 menu">즉시 구매가</dt>
								<dd class="col-xs-4">
									<p class="won">원</p>
									<input type="text" class="buy inputwon" />
								</dd>
							</dl>
						</dd>
