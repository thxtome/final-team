...
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/css/auction/searchsidebar.css" />">
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/css/auction/searchcontent.css" />">
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/css/auction/searchbar.css" />">
<link
	...
	<div id="wrapper">
		<div id="sidebar">
			<div class="category checklist categorylist box-line">
				...
				<ul>
					<c:forEach var="category" items="${category}">
						<li><i
							class="fas fa-${category.categoryIcon} category-filter"></i> <a
							class="category cnkfilter" id="category${category.categoryCode}"
							href="<c:url value="/auction/searchActionList.do" />"
							data-selected="" data-name="categoryCode"
							data-value="${category.categoryCode}"
							title="${category.categoryName}"> ${category.categoryName} </a></li>
					</c:forEach>
				</ul>
			</div>
			<div class="checklist box-line accordion" id="price_filter">
				...
				<ul>
					<li><a href="<c:url value="/auction/searchActionList.do" />"
						class="price-filter cnkfilter" data-name="priceChoice"
						data-selected="" data-value="0-20000" title="2만원 미만">2만원 미만</a></li>
					<li><a href="<c:url value="/auction/searchActionList.do" />"
						class="price-filter cnkfilter" data-name="priceChoice"
						data-selected="" data-value="20000-50000" title="2만원 ~ 5만원">2만원
							~ 5만원</a></li>
					<li><a href="<c:url value="/auction/searchActionList.do" />"
						class="price-filter cnkfilter" data-name="priceChoice"
						data-selected="" data-value="50000-100000" title="5만원 ~ 10만원">5만원
							~ 10만원</a></li>
					<li><a href="<c:url value="/auction/searchActionList.do" />"
						class="price-filter cnkfilter" data-name="priceChoice"
						data-selected="" data-value="100000-200000" title="10만원 ~ 20만원">10만원
							~ 20만원</a></li>
					<li><a href="<c:url value="/auction/searchActionList.do" />"
						class="price-filter cnkfilter" data-name="priceChoice"
						data-selected="" data-value="200000-123123111" title="20만원 이상">20만원
							이상</a></li>
					<li><input class="price-filter cnkfilter"
						data-name="priceChoice" data-value="" id="num1" data-selected=""
						type="text" numberOnly /> ~ <input class="price-filter cnkfilter"
						data-name="priceChoice" data-value="" id="num2" data-selected=""
						type="text" numberOnly /> <a
						href="<c:url value="/auction/searchActionList.do" />"
						id="price_choice" class="price-filter" data-name="priceChoice"
						data-selected="" data-value="priceChoice"></a></li>
				</ul>
			</div>
			<div class="checklist box-line accordion" id="date">
				...
				<ul>
					<li><a href="<c:url value="/auction/searchActionList.do" />"
						class="time-filter cnkfilter" data-name="limits" data-selected=""
						data-value="1" title="오늘까지">오늘까지</a></li>
					<li><a href="<c:url value="/auction/searchActionList.do" />"
						class="time-filter cnkfilter" data-name="limits" data-selected=""
						data-value="2" title="내일까지">내일까지 </a></li>
					<li><a href="<c:url value="/auction/searchActionList.do" />"
						class="time-filter cnkfilter" data-name="limits" data-selected=""
						data-value="3" title="3일 이상">3일 이상 </a></li>
				</ul>
			</div>
			<div class="checklist box-line accordion" id="bidcount">
				...
				<ul>
					<li><a href="<c:url value="/auction/searchActionList.do" />"
						class="bid-filter cnkfilter" data-name="bidCount" data-selected=""
						data-value="3-777777" title="3건이상">3건 이상</a></li>
					<li><a href="<c:url value="/auction/searchActionList.do" />"
						class="bid-filter cnkfilter" data-name="bidCount" data-selected=""
						data-value="5-777777" title="5건이상">5건 이상</a></li>
					<li><a href="<c:url value="/auction/searchActionList.do" />"
						class="bid-filter cnkfilter" data-name="bidCount" data-selected=""
						data-value="10-777777" title="10건이상">10건 이상</a></li>
				</ul>
			</div>
		</div>
		...
		<div class="layout-right">
			<div class="py-4 bg-light" id="content">
				<div class="option_selectbar" id="selectbar">
					<a id="resetfilter" href="" class="clear"> <span
						class="option-clean"></span> 전체해제
							...
							<div class="card-body" style="">
								...
								<div class="sort_area">
									<ul class="sort_list" id="sort_list">
										<li><a class="order"
											href="<c:url value="/auction/searchActionList.do" />"
											data-selected="" data-name="sorts" data-value="maxPrice"
											title="낮은 가격순"><span></span>낮은 가격순</a></li>
										<li><a class="order"
											href="<c:url value="/auction/searchActionList.do" />"
											data-selected="" data-name="sorts" data-value="maxPrice desc"
											title="높은 가격순"><span></span>높은 가격순</a></li>
										<li><a class="order"
											href="<c:url value="/auction/searchActionList.do" />"
											data-selected="" data-name="sorts"
											data-value="auction_reg_date desc" title="등록일순"><span></span>등록일순</a></li>
										<li><a class="order"
											href="<c:url value="/auction/searchActionList.do" />"
											data-selected="" data-name="sorts" data-value="bidCnt desc"
											title="입찰 많은순"><span></span>입찰횟수순</a></li>
									</ul>
									<span class="view_count"> <select id="view">
										...
										<a class="auction_list"
											...
											<div class="card box-shadow">
												...
												<c:choose>
													...
													<c:otherwise>
														<p class="card-text m-1">
															<fmt:formatNumber value="${list.maxPrice}"
																pattern="#,###" />
															원
														</p>
													</c:otherwise>
