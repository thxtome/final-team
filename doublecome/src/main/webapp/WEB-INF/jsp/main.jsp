      ...
      <div class="row">
        <div class="col-md-4 p-2" style="">
          <div class="card box-shadow">
            <img class="card-img-top w-100" src="../../../Users/wls82/OneDrive/사진/imax(1).jfif" style="height: 250px;">
            <p class="mb-1 m-1">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p>
            <p class="card-text m-1">50,000원</p><small class="text-muted m-1">3 days ago</small>
          </div>
        </div>
        <div class="col-md-4 p-2" style="">
          <div class="card box-shadow">
